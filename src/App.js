    ...
    <div className="bg-black text-white min-h-screen text-center flex flex-col justify-start items-center w-screen">
      {!buttonClicked && (
        <div style={{ position: 'relative', marginBottom: '2rem' }}>
          <div>
            <h1 className="text-4xl font-semibold mt-4 px-5 mb-2">ℕostrNet.work</h1>
             <h2 className="text-sm font-semibold mx-8 mb-4 px-5">ℕostrNetwork, It offers a unified dashboard to manage all your Nostr web apps in one place. (Beta)</h2>
          </div>
