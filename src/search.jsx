...
const SearchForm = ({ value, onChange, onSubmit, placeholder }) => (
  <form onSubmit={onSubmit} className="flex items-center rounded p-">
    <input
      type="text"
      name="q"
      value={value}
...
const DuckDuckGoSearchBar = () => {
  ...
  const closeModal = () => {
    ...
    return (
      ...
      {/* Modal */}
      {modalContent && (
        <div className="fixed inset-3  items-center p-2 justify-center bg-opacity-50 z-10">
          <div className=" h-full  w-full  rounded-lg ">
            <button onClick={closeModal}  className=" absolute top-0  font-mono font-semibold rounded-full text-black bg-gray-300 right-0">
